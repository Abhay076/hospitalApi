...
describe("Patients Register Testing :", () => {
  let Token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..F0dH8j9IWcUD6-71eFjD7mtrxp1FhGWvgjX-fZQWMrA";
    ...
    it("Patient already Exist:", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have
            .property("message")
            .eql("Patient already Registered DB");
          done();
        });
    });
  });
    ...
    it("Patient Successfully Registered:", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have
            .property("message")
            .eql("Patient Successfully Registered");
          done();
        });
    });
  });
